...
for (let type in optionTypes) {
  describe(`Component OrderOption with type=${type}`, () => {
    ...
    switch (type) {
      ...
      case 'icons': {
        it('should render div with name icon', () => {
          const classIcon = renderedSubcomponent.find('.icon .icon');
          expect(classIcon.length).toBe(2);
        });

        it('should start setOrderOption function by click', () => {
      ...
      case 'date': {
        ...
        it('should start SetOrderOption on change', () => {
      ...
      case 'text': {
        ...
        it('should start setOrderOption function on change', () => {
      ...
      case 'number': {
        it('should render input with number', () => {
